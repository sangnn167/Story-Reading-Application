...
const PsychologicalStory = () => {
  const PsychologicalStories = storiesData.filter((story) => story.category.includes("Psychological"));
  return (
        ...
        <div className={styles.list}>
          <div className={styles.containerLeft}>
            ...
            <div className={styles.itemleft}>
                <StoryList stories={PsychologicalStories}/>
            </div>
          </div>
          <TopViews stories={PsychologicalStories} />
        </div>
      </div>
    </div>
  );
};
export default PsychologicalStory;
