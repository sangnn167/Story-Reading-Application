...
const HaremStory = () => {
  const HaremStories = storiesData.filter((story) => story.category.includes("Harem"));
  return (
        ...
        <div className={styles.list}>
          <div className={styles.containerLeft}>
            ...
            <div className={styles.itemleft}>
                <StoryList stories={HaremStories}/>
            </div>
          </div>
          <TopViews stories={HaremStories} />
        </div>
      </div>
    </div>
  );
};
export default HaremStory;
