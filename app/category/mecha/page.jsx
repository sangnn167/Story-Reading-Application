...
const MechaStory = () => {
  const MechaStories = storiesData.filter((story) => story.category.includes("Mecha"));
  return (
        ...
        <div className={styles.list}>
          <div className={styles.containerLeft}>
            ...
            <div className={styles.itemleft}>
                <StoryList stories={MechaStories}/>
            </div>
          </div>
          <TopViews stories={MechaStories} />
        </div>
      </div>
    </div>
  );
};
export default MechaStory;
